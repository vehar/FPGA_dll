...
extern int DebugOutActive; //if(DebugOutActive) if(DebugOutActive) printf
...
bool FPGA_Write_Prg_Buf(unsigned short *Buf, unsigned short nr)
{
 ...
 //  if(DebugOutActive) printf("Programming Fpga... ");
...
if(dwBytesRead != nr) {size += dwBytesRead; break;};
 ...
 if(DebugOutActive) printf("size = %d",size);
//if(DebugOutActive) printf("End Programming Fpga.\n");
//===========================================================
   return !IsError;
}
