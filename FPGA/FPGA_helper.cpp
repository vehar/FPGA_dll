...
//резкое падение потреблени€!!! после этой записи
...
FPGA.setTgcState(1);//TgcEn - при 0 - пропадала генераци€ //FPGA_Write(_TGC_EN_MR ,1); //>>IN_SET	
//===================================================================================================
...
/*!*/FPGA.setSignalIntegration(0);// оличество точек, по которым интегрируетс€ сигнал = 2^ IntegratorKoef //0=off
//////Analog init end/////////////////////////////////////////////////////////////////
}
