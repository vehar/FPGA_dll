...
{	
	...
	{ 
		...
		case F_A_FREEZE_ON:		AScan_not_freesed = 0; AScanFileInit(); AScanFileWrite(0);break;//СТОП-КАДР ВКЛ (A-scan)
		case F_A_FREEZE_OFF:	AScan_not_freesed = 1; ReadDisplayAScan(); break;//СТОП-КАДР ВЫКЛ (A-scan)
